...
for (const marker of [
  ...
  'edition-production-preflight.sql',
  'report.migration_history.state, "expected_full_history"',
  'report.worker_deployment_authorized, false',
  'report.automatic_publication_authorized, false',
